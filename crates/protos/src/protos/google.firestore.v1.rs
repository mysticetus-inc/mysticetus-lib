...
pub mod value {
    ...
    pub enum ValueType {
        /// A null value.
        #[prost(enumeration = "super::super::super::protobuf::NullValue", tag = "11")]
        NullValue(i32),
        /// A boolean value.
        #[prost(bool, tag = "1")]
        BooleanValue(bool),
...
pub mod structured_query {
    ...
    pub mod field_filter {
        ...
        pub enum Operator {
            ...
            /// * No other `OR`, `IN`, `ARRAY_CONTAINS_ANY`, `NOT_IN`, `NOT_EQUAL`, `IS_NOT_NULL`,
            ///   or `IS_NOT_NAN`.
            /// * That `field` comes first in the `order_by`.
            NotIn = 10,
        }
...
pub mod structured_aggregation_query {
    ...
    pub mod aggregation {
        ...
        pub struct Count {
            ...
            #[prost(message, optional, tag = "1")]
            pub up_to: ::core::option::Option<super::super::super::super::protobuf::Int64Value>,
        }
...
pub struct ExecutionStats {
    ...
    #[prost(message, optional, tag = "3")]
    pub execution_duration: ::core::option::Option<super::super::protobuf::Duration>,
