...
pub struct AutoscalingConfig {
    ...
    pub asymmetric_autoscaling_options:
        ::prost::alloc::vec::Vec<autoscaling_config::AsymmetricAutoscalingOption>,
}
...
pub mod autoscaling_config {
    ...
    pub struct AsymmetricAutoscalingOption {
        ...
        #[prost(message, optional, tag = "2")]
        pub overrides:
            ::core::option::Option<asymmetric_autoscaling_option::AutoscalingConfigOverrides>,
    }
...
pub mod instance_admin_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// [CreateInstanceConfigMetadata][google.spanner.admin.instance.v1.
        /// CreateInstanceConfigMetadata]. The [response][google.longrunning.Operation.
        /// response] field type is [InstanceConfig][google.spanner.admin.instance.v1.
        ...
        /// UpdateInstanceConfigMetadata]. The [response][google.longrunning.Operation.
        /// response] field type is [InstanceConfig][google.spanner.admin.instance.v1.
        /// InstanceConfig], if successful.
        ///
        ...
        /// [metadata][google.longrunning.Operation.metadata] field type is
        /// [CreateInstancePartitionMetadata][google.spanner.admin.instance.v1.
        /// CreateInstancePartitionMetadata]. The [response][google.longrunning.Operation.
        /// response] field type is [InstancePartition][google.spanner.admin.instance.v1.
        ...
        /// UpdateInstancePartitionMetadata]. The [response][google.longrunning.Operation.
        /// response] field type is [InstancePartition][google.spanner.admin.instance.v1.
        /// InstancePartition], if successful.
        ///
        ...
        /// `projects/<project>/instances/<instance>/instancePartitions/<instance_partition>/
        /// operations/<operation>`. The long-running operation
        /// [metadata][google.longrunning.Operation.metadata] field type
        /// `metadata.type_url` describes the type of the metadata. Operations returned
        /// include those that have completed/failed/canceled within the last 7 days,
        /// and pending operations. Operations returned are ordered by
