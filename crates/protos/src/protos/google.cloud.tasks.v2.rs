...
///
/// * Cloud Tasks backs off on all errors. Normally the backoff specified in \[rate
///   limits\]\[google.cloud.tasks.v2.Queue.rate_limits\] will be used. But if the worker returns
///   `429` (Too Many Requests), `503` (Service Unavailable), or the rate of errors is high, Cloud
///   Tasks will use a higher backoff rate. The retry specified in the `Retry-After` HTTP response
///   header is considered.
///
/// * To prevent traffic spikes and to smooth sudden increases in traffic, dispatches ramp up slowly
///   when the queue is newly created or idle and if large numbers of tasks suddenly become
...
///   queue\]\[google.cloud.tasks.v2.Queue.app_engine_routing_override\], this value is used for all
...
pub struct AppEngineHttpRequest {
    ...
    ///
    /// * If \[app_engine_routing_override is set on the
    ///   queue\]\[google.cloud.tasks.v2.Queue.app_engine_routing_override\], this value is used
    ...
    ///   `"application/octet-stream"`. The default can be overridden by explicitly setting
    ///   `Content-Type` to a particular media type when the \[task is
    ///   created\]\[google.cloud.tasks.v2.CloudTasks.CreateTask\]. For example, `Content-Type` can
    ///   be set to `"application/json"`.
    /// * `Content-Length`: This is computed by Cloud Tasks. This value is output only.   It cannot
    ///   be changed.
    ///
...
pub struct Queue {
    ...
    /// * `QUEUE_ID` can contain letters (\[A-Za-z\]), numbers (\[0-9\]), or hyphens (-). The
    ...
    ///   dispatches from a queue (i.e. all traffic dispatched from the queue, regardless of
    ...
    ///   \[retry_config\]\[google.cloud.tasks.v2.Queue.retry_config\], and the \[queue's
    ///   state\]\[google.cloud.tasks.v2.Queue.state\].
    ...
    pub purge_time: ::core::option::Option<super::super::super::protobuf::Timestamp>,
...
pub struct RetryConfig {
    ...
    /// queue.yaml/xml](<https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters>).
    #[prost(message, optional, tag = "2")]
    pub max_retry_duration: ::core::option::Option<super::super::super::protobuf::Duration>,
    ...
    /// queue.yaml/xml](<https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters>).
    #[prost(message, optional, tag = "3")]
    pub min_backoff: ::core::option::Option<super::super::super::protobuf::Duration>,
    /// A task will be \[scheduled\]\[google.cloud.tasks.v2.Task.schedule_time\] for
    /// retry between \[min_backoff\]\[google.cloud.tasks.v2.RetryConfig.min_backoff\]
    /// and \[max_backoff\]\[google.cloud.tasks.v2.RetryConfig.max_backoff\] duration
    /// after it fails, if the queue's
    ...
    /// queue.yaml/xml](<https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters>).
    #[prost(message, optional, tag = "4")]
    pub max_backoff: ::core::option::Option<super::super::super::protobuf::Duration>,
...
pub struct Task {
    ...
    /// * `QUEUE_ID` can contain letters (\[A-Za-z\]), numbers (\[0-9\]), or hyphens (-). The
    ///   maximum length is 100 characters.
    /// * `TASK_ID` can contain only letters (\[A-Za-z\]), numbers (\[0-9\]), hyphens (-), or
    ...
    #[prost(message, optional, tag = "4")]
    pub schedule_time: ::core::option::Option<super::super::super::protobuf::Timestamp>,
    ...
    ///
    /// * For \[HTTP tasks\]\[google.cloud.tasks.v2.HttpRequest\], the default is 10 minutes. The
    ///   deadline must be in the interval \[15 seconds, 30 minutes\].
    ///
    ...
    #[prost(message, optional, tag = "6")]
    pub dispatch_deadline: ::core::option::Option<super::super::super::protobuf::Duration>,
...
pub struct Attempt {
    ...
    #[prost(message, optional, tag = "2")]
    pub dispatch_time: ::core::option::Option<super::super::super::protobuf::Timestamp>,
    /// Output only. The time that this attempt response was received.
    ///
    /// `response_time` will be truncated to the nearest microsecond.
    #[prost(message, optional, tag = "3")]
    pub response_time: ::core::option::Option<super::super::super::protobuf::Timestamp>,
