...
pub struct PartialResultSet {
    ...
    /// [chunked_value][google.spanner.v1.PartialResultSet.chunked_value] field. Two or more
    /// chunked values can be merged to form a complete value as follows:
    ///
    ...
    /// chunked, and must be combined with more values from subsequent `PartialResultSet`s
