...
pub struct TransactionOptions {
    ...
    ///
    /// * If the DDL option `allow_txn_exclusion` is set to `true`, then the updates made within
    ///   this transaction aren't recorded in the change stream.
    ///
...
pub mod transaction_options {
    ...
    pub mod read_write {
        ...
        pub enum ReadLockMode {
            ...
            ///   \[REPEATABLE_READ\]\[google.spanner.v1.TransactionOptions.IsolationLevel.
            ///   REPEATABLE_READ\], then it is an error to specify `read_lock_mode`. Locking
            ///   semantics default to `OPTIMISTIC`. No validation checks are done for reads, except
            ///   to validate that the data that was served at the snapshot time is unchanged at
            ///   commit time in the following cases:
            ///   1. reads done as part of queries that use `SELECT FOR UPDATE`
            ///   1. reads done as part of statements with a `LOCK_SCANNED_RANGES` hint
            ///   1. reads done as part of DML statements
            /// * At all other isolation levels, if `read_lock_mode` is the default value, then
            ///   pessimistic read locks are used.
            Unspecified = 0,
    ...
    pub mod read_only {
        ...
        pub enum TimestampBound {
            ...
            #[prost(message, tag = "2")]
            MinReadTimestamp(super::super::super::super::protobuf::Timestamp),
            ...
            /// transactions.
            #[prost(message, tag = "3")]
            MaxStaleness(super::super::super::super::protobuf::Duration),
            ...
            /// Example: `"2014-10-02T15:01:23.045123456Z"`.
            #[prost(message, tag = "4")]
            ReadTimestamp(super::super::super::super::protobuf::Timestamp),
...
pub struct Transaction {
    ...
    /// \[TransactionOptions.ReadOnly.return_read_timestamp\]\[google.spanner.v1.
    /// TransactionOptions.ReadOnly.return_read_timestamp\].
    ///
    /// A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds.
    /// Example: `"2014-10-02T15:01:23.045123456Z"`.
    #[prost(message, optional, tag = "2")]
    pub read_timestamp: ::core::option::Option<super::super::protobuf::Timestamp>,
...
pub struct CommitResponse {
    ...
    pub commit_timestamp: ::core::option::Option<super::super::protobuf::Timestamp>,
    ...
    pub snapshot_timestamp: ::core::option::Option<super::super::protobuf::Timestamp>,
...
pub mod key_range {
    ...
    pub enum StartKeyType {
        ...
        #[prost(message, tag = "1")]
        StartClosed(super::super::super::protobuf::ListValue),
        /// If the start is open, then the range excludes rows whose first
        /// `len(start_open)` key columns exactly match `start_open`.
        #[prost(message, tag = "2")]
        StartOpen(super::super::super::protobuf::ListValue),
    }
    /// The end key must be provided. It can be either closed or open.
    #[derive(serde::Deserialize, serde::Serialize)]
    #[serde(rename_all = "camelCase")]
    ...
    pub enum EndKeyType {
        ...
        #[prost(message, tag = "3")]
        EndClosed(super::super::super::protobuf::ListValue),
        /// If the end is open, then the range excludes rows whose first
        /// `len(end_open)` key columns exactly match `end_open`.
        #[prost(message, tag = "4")]
        EndOpen(super::super::super::protobuf::ListValue),
    }
}
...
pub struct KeySet {
    ...
    pub keys: ::prost::alloc::vec::Vec<super::super::protobuf::ListValue>,
...
pub mod struct_type {
    ...
    pub struct Field {
        ...
        /// columns might have an empty name (e.g., `"SELECT  UPPER(ColName)"`). Note that a query
...
pub struct Tablet {
    ...
    ///
    /// * If the request is using a directed read, eliminate any tablets that do not match the
    ///   directed read's target zone and/or replica type.
    /// * (Read-write transactions only) Choose leader tablet if it has an distance \<=5.
    /// * Group and sort tablets by distance. Choose a random tablet with the lowest distance. If
    ///   the request is not a directed read, only consider replicas with distances \<=5.
...
pub mod key_recipe {
    ...
    pub mod part {
        ...
        pub enum ValueType {
            ...
            #[prost(message, tag = "6")]
            Value(super::super::super::super::protobuf::Value),
...
pub mod mutation {
    ...
    pub struct Delete {
        ...
        /// keys must be specified in the order in which they appear in the `PRIMARY  KEY()` clause
        /// of the table's equivalent DDL statement (the DDL statement used to create the
        /// table). Delete is idempotent. The transaction will succeed even if some or all
        /// rows do not exist.
        #[prost(message, optional, tag = "2")]
    ...
    pub struct Send {
        ...
        #[prost(message, optional, tag = "2")]
        pub key: ::core::option::Option<super::super::super::protobuf::ListValue>,
        ...
        #[prost(message, optional, tag = "3")]
        pub deliver_time: ::core::option::Option<super::super::super::protobuf::Timestamp>,
        /// The payload of the message.
        #[prost(message, optional, tag = "4")]
        pub payload: ::core::option::Option<super::super::super::protobuf::Value>,
    }
...
pub struct PlanNode {
    ...
    pub metadata: ::core::option::Option<super::super::protobuf::Struct>,
    /// The execution statistics associated with the node, contained in a group of
    /// key-value pairs. Only present if the plan was returned as a result of a
    /// profile query. For example, number of executions, number of rows/time per
    /// execution etc.
    #[prost(message, optional, tag = "7")]
    pub execution_stats: ::core::option::Option<super::super::protobuf::Struct>,
}
...
pub struct ResultSetMetadata {
    ...
    /// set. For example, a SQL query like `"SELECT UserId, UserName FROM  Users"` could return a
    /// `row_type` value like:
    ///
    /// ```text
    /// "fields": [
    ...
    /// parameters in the SQL query. For example, a SQL query like `"SELECT * FROM  Users where
    /// UserId = @userId and UserName = @userName "` could return a `undeclared_parameters`
    /// value like:
    ///
    /// ```text
    /// "fields": [
...
pub struct ResultSetStats {
    ...
    /// ```
    #[prost(message, optional, tag = "2")]
    pub query_stats: ::core::option::Option<super::super::protobuf::Struct>,
...
pub struct ListSessionsRequest {
    ...
    /// * `labels.env:dev` --> The session has the label "env" and the value of the label contains
    ///   the string "dev".
    #[prost(string, tag = "4")]
...
pub mod request_options {
    ...
    ///   specified priority. This can cause you to see an increase in high priority workload even
    ///   when executing a low priority request. This can also potentially cause a priority
    ///   inversion where a lower priority request is fulfilled ahead of a higher priority request.
    /// * If a transaction contains multiple operations with different priorities, Cloud Spanner
    ///   doesn't guarantee to process the higher priority operations first. There might be other
    ///   constraints to satisfy, such as the order of operations.
    #[derive(serde::Deserialize, serde::Serialize)]
    #[serde(rename_all = "camelCase")]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
...
pub mod directed_read_options {
    ...
    /// selection:
    ///
    /// * `location` - The location must be one of the regions within the multi-region configuration
    ///   of your database.
    /// * `type` - The type of the replica.
    ///
    /// Some examples of using replica_selectors are:
    ///
    /// * `location:us-east1` --> The "us-east1" replica(s) of any available type is used to process
    ///   the request.
    /// * `type:READ_ONLY`    --> The "READ_ONLY" type replica(s) in the nearest available location
...
pub struct ExecuteSqlRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub params: ::core::option::Option<super::super::protobuf::Struct>,
...
pub mod execute_batch_dml_request {
    ...
    pub struct Statement {
        ...
        /// It's an error to execute a SQL statement with unbound parameters.
        #[prost(message, optional, tag = "2")]
        pub params: ::core::option::Option<super::super::super::protobuf::Struct>,
        /// It isn't always possible for Cloud Spanner to infer the right SQL type
        /// from a JSON value. For example, values of type `BYTES` and values
        /// of type `STRING` both appear in
...
/// 1. If the status was not `OK`, check the number of result sets in the response. If the response
///    contains `N` \[ResultSet\]\[google.spanner.v1.ResultSet\] messages, then statement `N+1` in
///    the request failed.
///
/// Example 1:
///
...
///   (`INVALID_ARGUMENT`) status. The number of \[ResultSet\]\[google.spanner.v1.ResultSet\]
///   messages indicates that the third statement failed, and the fourth and fifth statements were
///   not executed.
#[derive(serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct CommitRequest {
    ...
    /// 500 ms.
    #[prost(message, optional, tag = "8")]
    pub max_commit_delay: ::core::option::Option<super::super::protobuf::Duration>,
    /// Common options for this request.
    #[prost(message, optional, tag = "6")]
    pub request_options: ::core::option::Option<RequestOptions>,
