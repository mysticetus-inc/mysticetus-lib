...
pub struct ListBucketsRequest {
    ...
    /// If no mask is specified, it defaults to all fields except `items.  owner`, `items.acl`, and
    /// `items.default_object_acl`. `*` might be used to mean "all fields".
    #[prost(message, optional, tag = "5")]
    pub read_mask: ::core::option::Option<super::super::protobuf::FieldMask>,
...
pub struct ReadObjectRequest {
    ...
    /// If no mask is specified, it defaults to all fields except `metadata.  owner` and
    /// `metadata.acl`. `*` might be used to mean "all fields".
...
pub struct GetObjectRequest {
    ...
    pub common_object_request_params: ::core::option::Option<CommonObjectRequestParams>,
    /// Mask specifying which fields to read.
    /// If no mask is specified, it defaults to all fields except `metadata.  acl` and
    /// `metadata.owner`. `*` might be used to mean "all fields".
    #[prost(message, optional, tag = "10")]
    pub read_mask: ::core::option::Option<super::super::protobuf::FieldMask>,
    /// Optional. Restore token used to differentiate soft-deleted objects with the
    /// same name and generation. Only applicable for hierarchical namespace
...
pub struct BucketAccessControl {
    ...
    ///   `domain-example.com` For project entities, `project-{team}-{projectnumber}` format is
...
pub struct ObjectContexts {
    ...
    pub custom:
        ::std::collections::HashMap<::prost::alloc::string::String, ObjectCustomContextPayload>,
}
