...
pub struct TimeInterval {
    ...
    pub end_time: ::core::option::Option<super::super::protobuf::Timestamp>,
    /// Optional. The beginning of the time interval.  The default value
    /// for the start time is the end time. The start time must not be
    /// later than the end time.
    #[prost(message, optional, tag = "1")]
    pub start_time: ::core::option::Option<super::super::protobuf::Timestamp>,
}
...
pub struct Aggregation {
    ...
    #[prost(message, optional, tag = "1")]
    pub alignment_period: ::core::option::Option<super::super::protobuf::Duration>,
...
pub struct MutationRecord {
    ...
    #[prost(message, optional, tag = "1")]
    pub mutate_time: ::core::option::Option<super::super::protobuf::Timestamp>,
...
pub mod alert_policy {
    ...
    pub mod condition {
        ...
        pub struct MetricThreshold {
            ...
            pub duration: ::core::option::Option<super::super::super::super::protobuf::Duration>,
        ...
        pub struct PrometheusQueryLanguageCondition {
            ...
            #[prost(message, optional, tag = "3")]
            pub evaluation_interval:
                ::core::option::Option<super::super::super::super::protobuf::Duration>,
    ...
    pub struct AlertStrategy {
        ...
        #[prost(
            enumeration = "alert_strategy::NotificationPrompt",
            repeated,
            tag = "2"
        )]
        ...
        #[prost(message, optional, tag = "3")]
        pub auto_close: ::core::option::Option<super::super::super::protobuf::Duration>,
    ...
    pub mod alert_strategy {
        ...
        pub struct NotificationRateLimit {
            ...
            #[prost(message, optional, tag = "1")]
            pub period: ::core::option::Option<super::super::super::super::protobuf::Duration>,
        }
        /// Control over how the notification channels in `notification_channels`
...
pub struct GetNotificationChannelVerificationCodeRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub expire_time: ::core::option::Option<super::super::protobuf::Timestamp>,
}
/// The `GetNotificationChannelVerificationCode` request.
#[derive(serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
pub mod service_level_objective {
    ...
    pub enum Period {
        ...
        #[prost(message, tag = "5")]
        RollingPeriod(super::super::super::protobuf::Duration),
...
pub mod basic_sli {
    ...
    pub struct LatencyCriteria {
        ...
        #[prost(message, optional, tag = "3")]
        pub threshold: ::core::option::Option<super::super::super::protobuf::Duration>,
    }
    /// This SLI can be evaluated on the basis of availability or latency.
    #[derive(serde::Deserialize, serde::Serialize)]
    #[serde(rename_all = "camelCase")]
...
pub struct WindowsBasedSli {
    ...
    #[prost(message, optional, tag = "4")]
    pub window_period: ::core::option::Option<super::super::protobuf::Duration>,
...
pub struct UptimeCheckConfig {
    ...
    /// defaults to `60s`.
    #[prost(message, optional, tag = "7")]
    pub period: ::core::option::Option<super::super::protobuf::Duration>,
    /// The maximum amount of time to wait for the request to complete (must be
    /// between 1 and 60 seconds). Required.
    #[prost(message, optional, tag = "8")]
    pub timeout: ::core::option::Option<super::super::protobuf::Duration>,
    ...
    pub mod http_check {
        ...
        pub mod service_agent_authentication {
            ...
            impl ServiceAgentAuthenticationType {
                ...
                pub fn as_str_name(&self) -> &'static str {
                    match self {
                        Self::Unspecified => "SERVICE_AGENT_AUTHENTICATION_TYPE_UNSPECIFIED",
